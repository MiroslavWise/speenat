...
const ServiceRule: NextPage = () => {
    return (
        <div className="wrapper terms show-animate">
            ...
            <p className="left">
                Выберите длительность консультации, определите диапазон цен и нажмите на поиск спикера
            </p>
            <p className="left">Из предоставленного списка выберите подходящего учебного специалиста</p>
            <p className="left">
                Пополните электронный счет{" "}
                <span style={{ color: "gray" }}>(личные данные вашей платежной карты не хранятся в нашем сервисе)</span>
            </p>
            <p className="left">Позвоните спикеру</p>
            <p className="left">
                По завершению консультации не забудьте оставить отзыв{" "}
                <span style={{ color: "gray" }}>(для нас важно ваше мнение)</span>
            </p>
            <br />
