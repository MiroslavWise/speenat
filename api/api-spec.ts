...
export const speakerSpecAdd = async (
    value: IDataReplaceSpec,
): Promise<ISpecList> => axiosInstance.post(`/speaker/spec/add/`, value)
export const speakerSpecEdit = async (
    id: any,
    value: IDataReplaceSpec,
): Promise<ISpecList> =>
    axiosInstance
...
export const specializationsAllList = async (): Promise<
    ISpecializationsAll[]
> =>
    axiosInstance
        .get(`/specialization/`)
